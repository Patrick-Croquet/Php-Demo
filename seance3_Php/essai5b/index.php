...
$sql = "UPDATE news SET auteur = :nvauteur, contenu = :nvcontenu, dateModif = NOW() WHERE titre = :titre"; 
...
$requete->execute(array('nvauteur' => $nvauteur,'nvcontenu' => $nvcontenu,'titre' => $titre));
