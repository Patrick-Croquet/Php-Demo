...
function translate($word, $direction)
{
    ...
    switch($direction)
    {
         ...
         *
         * Il s'agit donc d'une étiquette dans le dictionnaire.
         * Est-ce que ce mot existe en tant qu'étiquette dans le dictionnaire ?
         */
        ...
        {
            // Oui, récupération de l'étiquette, de la traduction en anglais.
